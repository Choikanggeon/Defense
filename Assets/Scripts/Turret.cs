...
public class Turret : MonoBehaviour
{
    ...
    [SerializeField] private float bps = 1f; // 초당 총알 수
    ...
    private void Update()
    {
       ...
       if(!CheckTargetIsInRange())
       ...
       else
        {
            ...
            if (timeUntilFire >= 1f / bps)//총쏘고난후경과시간 >= 총알 발사 주기
            {
                Shoot();
                Flash();
                timeUntilFire = 0f;
    ...
    private void RotateTowardsTarget()
    {
        ...
        turretRotationPoint.rotation = /*targetRotation;*/Quaternion.RotateTowards/*위치회전변경할때 회전보간*/(turretRotationPoint.rotation, targetRotation,
